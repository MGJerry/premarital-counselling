# SWP391 - Topic 3
# Spring Boot RestAPI for Premarital Counselling Website (Back-End)
...
On first run, `spring.jpa.hibernate.ddl-auto` must be set to `create` to create the necessary tables and relationships.
