...
public class PaymentService {
    public String createURLPayment(Expert expert) throws Exception {
        ...
        vnpParams.put("vnp_OrderInfo", "Thanh toan cho ma GD: " + txnRef);
        vnpParams.put("vnp_OrderType", "other");
        vnpParams.put("vnp_Amount", expert.getConsultingPrice().multiply(BigDecimal.valueOf(100)).toBigInteger().toString());
